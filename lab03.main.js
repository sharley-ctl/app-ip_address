 ...
 * @return {object} (ipAddresses) - An object containing both the ipv4 address and ipv6 address.
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  if (!cidr.isValid()) {
    ...
    ipAddresses.ipv4 = firstIpAddress;
    ipAddresses.ipv6 = getIpv4MappedIpv6Address(firstIpAddress)
  }
